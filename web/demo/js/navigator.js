...
function Navigator()
{
	...
	this.pageCodes[4] = new Array('tipPage', '<table class="tipControl"><tr><td colspan="2"><div class="tipContainer"></div></td></tr><tr><td><span class="link" oname="tip.back" onclick="return worker.execute(this);">Volver</span></td><td><span class="link" oname="tip.participants" onclick="return worker.execute(this);" ;>Asistentes</span></td></tr></table>',
		function()
		{
	...
	this.pageCodes[8] = new Array('postPage', '<table class="PostControl"><tr><td colspan="2"></td></tr><tr><td colspan="2"></td></tr></table>',
		function()
		{
			...
			var editForm='<table class="editForm">' + 
				...
				'<tr><td><span class="link" oname="post.cancel" onclick="return worker.execute(this);" >Cancelar</span></td><td><span class="link" oname="post.save" onclick="return worker.execute(this);" >Publicar</span></td></tr></table>';
...
// Constructor
	this.homePage = this.pageCodes[3];
	this.placeCode = 'scl';
	this.userId = 0;
